...
namespace QuanLiBanHang
{
    public partial class frmPhieuTraNo : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'quanLiDoChoiDataSet1.PhieuTraNo' table. You can move, or remove it, as needed.
            this.phieuTraNoTableAdapter.Fill(this.quanLiDoChoiDataSet1.PhieuTraNo);
            LoadDataGridView();
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            {
                string MaPhieuTraNo = txtMaPhieuGN.Text.Trim();
                string NgayTraStr = txtNgayTra.Text.Trim();
                ...
                // Kiểm tra và chuyển đổi chuỗi NgayTra thành kiểu DateTime
                DateTime NgayTra;
                if (!DateTime.TryParseExact(NgayTraStr, "dd/MM/yyyy", CultureInfo.InvariantCulture, DateTimeStyles.None, out NgayTra))
                {
                    MessageBox.Show("Ngày trả không hợp lệ. Vui lòng nhập theo định dạng dd/MM/yyyy", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return;
                }

                // Thực hiện thêm mới vào CSDL
                string sql = $"INSERT INTO PhieuTraNo (MaPhieuTraNo, NgayTra, SoTienTra, MaHoaDon) VALUES ('{MaPhieuTraNo}', '{NgayTra.ToString("yyyy-MM-dd")}', {SoTienTra}, '{cboMaHD.Text.Trim()}')";
                Functions.RunSQL(sql);
        ...
        private void dgvPhieuTraNo_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
        ...
        private void dgvPhieuTraNo_Click(object sender, EventArgs e)
        {
            ...
            txtNgayTra.Text = dgvPhieuTraNo.CurrentRow.Cells[1].Value.ToString();
        ...
        private void btnTimKiem_Click(object sender, EventArgs e)
        {
            ...
            if (tblPhieuTraNo.Rows.Count > 0)
            {
                ...
                txtNgayTra.Text = tblPhieuTraNo.Rows[0]["NgayTra"].ToString();
                txtSoTienTra.Text = tblPhieuTraNo.Rows[0]["SoTienTra"].ToString();
                cboMaHD.Text = tblPhieuTraNo.Rows[0]["MaHoaDon"].ToString();
